 ...
 */
public class ZCViewPager extends ViewPager {

    public static final String TAG = ZCViewPager.class.getSimpleName();
    ...
    public ZCViewPager(Context context) {
        this(context, null);
    }

    @SuppressWarnings("incomplete-switch")
    public ZCViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        setClipChildren(false);
        // now style everything!
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ZCViewPager);
        int effect = ta.getInt(R.styleable.ZCViewPager_style, 0);
        ...
        setFadeEnabled(ta.getBoolean(R.styleable.ZCViewPager_fadeEnabled, false));
        setOutlineEnabled(ta.getBoolean(R.styleable.ZCViewPager_outlineEnabled, false));
        setOutlineColor(ta.getColor(R.styleable.ZCViewPager_outlineColor, Color.WHITE));
        switch (mEffect) {
            case Stack:
            case ZoomOut:
                setFadeEnabled(true);
